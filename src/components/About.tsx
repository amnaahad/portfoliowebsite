        ...
        <div className="grid grid-cols-8 gap-6 place-items-center">
            ...
            <div className=" w-full col-span-5 relative bg-white/10 backdrop-blur-lg border border-white/20 rounded-xl overflow-hidden">
              ...
              <div className="flex flex-row p-6">
                ...
                <div className="flex flex-col mt-4">
                    ...
                    <p className='text-lg text-white/70 mt-2'>I am currently pursuing Bachelor's degree in Computer Science at the National University of Modern Languages.</p>
              </div>
              </div>
            </div>
            ...
            <div className="absolute inset-0 bg-gradient-to-r from-orange-400 via-purple-700 to-orange-800 opacity-30 animate-gradient-xy"></div>
              <div className="flex flex-row p-6">
                ...
                <div className="flex flex-col mt-4">
                    ...
                    <p className='text-lg text-white/70 mt-2'>I possess a diverse range of project experience.</p>
              </div>
              </div>
            </div>
            ...
            <div className="flex flex-row p-6">
                ...
                <div className="flex flex-col mt-4">
                    ...
                    <p className='text-lg text-white/70 mt-2'>As a Full Stack Developer, I specialize in the MERN stack and Next.js, leveraging version control to build scalable web applications.</p>
              </div>
              </div>
            </div>
        </div>
